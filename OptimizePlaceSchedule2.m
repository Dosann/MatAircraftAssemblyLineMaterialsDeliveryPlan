...
while itercount<=maxiter&&~isempty(confli_jobs)
    ...
    for i=1:3
        ...
        [feasibility_3(i),conflis_3{i},~,~]=InsertJobForceByDire(area,place_pos,jobid,arriv_time,l,'top',2);
    end
    try
    ...
    [~,~,area,place_pos]=InsertJobForceByDire(area,place_pos,jobid,arriv_time,lms(jobid)+insert_l-2,'top',1);
